...
$kelompokBeda = array_merge(array_diff($bil1, $bil2), array_diff($bil2, $bil1)); //array merge buat ngegabungin dan array unique menghilangkan duplikat
rsort($kelompoksama); //rsort buat nampilin nilai terbesar atau terkecil
rsort($kelompokBeda); // 
